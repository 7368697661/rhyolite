...
export default function ProjectSidebar({
  ...
  return (
    <div className="flex h-full flex-col gap-0 overflow-y-auto text-sm text-violet-100/90">
      ...
      {activeProjectId && (
        <>
          <div className="flex flex-col gap-1 border-b border-violet-600/30 px-3 py-3">
            <div className="group flex items-center justify-between">
              ...
              <button
                ...
                className="text-[10px] font-semibold uppercase tracking-wide text-violet-600 opacity-0 transition-opacity hover:text-violet-300 group-hover:opacity-100"
              >
                + Add
              </button>
            </div>
            <div className="flex flex-col">
              {documents.map((doc) => {
                ...
                return (
                  <div key={doc.id} className="group/item relative border-b border-violet-900/40">
                    <button
                    ...
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover/item:opacity-100 hover:text-white transition-opacity p-1"
                      title="Rename"
                    >
              ...
              {documents.length === 0 && (
                <span className="px-2 py-2 text-xs text-violet-800">No chapters yet</span>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1 border-b border-violet-600/30 px-3 py-3">
            ...
            <div className="flex flex-col">
              {wikiEntries.map((wiki) => {
                const isActive = activeItem?.type === "wiki" && activeItem.id === wiki.id;
                return (
                  <div key={wiki.id} className="group/item relative border-b border-violet-900/40">
                    <button
