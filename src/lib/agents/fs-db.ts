...
export type FsGlyph = { id: string; name: string; provider: string; model: string; temperature: number; outputLength: number; maxOutputTokens?: number; isSculpter: boolean; specialistRole?: string; systemInstruction?: string; role?: string; };
